public class Lab21_Objects {
	...
	public static void main(String[] args) {
		...
		dlist[2] = new Dummy(iarr[0]);
		 
		dlist[3] = new Dummy(darr[0]);
		
		dlist[4] = new Dummy(iarr);
		
		dlist[5] = new Dummy(darr);
		
		dlist[6] = new Dummy(dlist[0]);
		
		dlist[7] = new Dummy(dlist);
		
		dlist[8] = new Dummy(iarr[0], darr[0]);
		
		dlist[9] = new Dummy(iarr, darr);
		
		dlist[10] = new Dummy(iarr[0], darr[0], dlist[0]);
		
		dlist[0] = new Dummy(iarr, darr, dlist);
